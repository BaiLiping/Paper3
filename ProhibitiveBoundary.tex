...
\begin{figure}[H]
\centering
\subfloat[Prohibitive Boundary at 0.5, Agents Trained over 300 Episodes, Evaluated over 5 Episodes.]{
	\label{subfig:0.5}
	\includegraphics[width=0.5\textwidth]{Cartpole_with_Boundary_at_0.5.png}}
\subfloat[Prohibitive Boundary at 0.7, Agents Trained over 300 Episodes, Evaluated over 5 Episodes.]{
  \label{subfig:0.7}
  \includegraphics[width=0.5\textwidth]{Cartpole_with_Boundary_at_0.7.png}}
\subfloat[Prohibitive Boundary at 0.9, Agents Trained over 300 Episodes, Evaluated over 5 Episodes.]{
  \label{subfig:0.9}
  \includegraphics[width=0.5\textwidth]{Cartpole_with_Boundary_at_0.9.png}}
